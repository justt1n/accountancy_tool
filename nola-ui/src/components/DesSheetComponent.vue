<template>
  <div class="sheet">
    ...
    <div class="form-control">
      <h2 class="text-xl font-bold dark:text-white p-2"></h2>
      <label
          ...
          <div class="form-control">
            <label class="cursor-pointer label">
              ...
              <input
                ...
                @change="handleSelectedSheets(sheet)"
              />
            </label>
          </div>
        </li>
...
export default {
  ...
  methods: {
    ...
    handleSelectedSheets(sheet) {
      ...
      this.$emit("spreadsheet-selected", this.srcSpreadsheetId);
      this.$emit("sheet-selected", this.selectedSheet); // Emit the selected sheet name
    },
  },
};
</script>
